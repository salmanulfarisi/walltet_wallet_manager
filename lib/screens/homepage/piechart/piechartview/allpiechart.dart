...
class AllPieChart extends StatefulWidget {
  const AllPieChart({
    Key? key,
  }) : super(key: key);

  @override
  State<AllPieChart> createState() => _AllPieChartState();
}

class _AllPieChartState extends State<AllPieChart> {
  final List<ChartData> chartData =
      chartLogic(TransactionDB.instance.transactionListNotifierNew.value);
  final List<ChartData> todayChartData =
      chartLogic(TransactionDB.instance.todayTransactionList.value);
  final List<ChartData> yesterdayChartData =
      chartLogic(TransactionDB.instance.yesterdayTransactionList.value);
  final List<ChartData> monthChartData =
      chartLogic(TransactionDB.instance.monthlyTransactionList.value);
