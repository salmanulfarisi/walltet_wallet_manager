...
class YesterdayAll extends StatefulWidget {
  const YesterdayAll({
    Key? key,
  }) : super(key: key);

  @override
  State<YesterdayAll> createState() => _YesterdayAllState();
}

class _YesterdayAllState extends State<YesterdayAll> {
  @override
        ...
        builder: (BuildContext context, List<TransactionModel> transactionList,
          ...
          return ListView.builder(
              itemBuilder: (BuildContext ctx, int index) {
                ...
                return DateFormat.MMMd().format(data.selectedDate) ==
